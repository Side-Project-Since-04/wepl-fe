  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: 'flex',
        head_cell: 'text-muted-foreground rounded-md w-[33px] font-normal text-[0.8rem]',
        row: 'flex w-full mt-[8px]',
        cell: 'h-[36px] w-[33px] text-center text-sm p-0 relative [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-outside)]:bg-accent/50 [&:has([aria-selected])]:bg-accent first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20',
