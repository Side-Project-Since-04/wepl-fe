...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    className={cn(
      'flex h-35 w-full m-8 items-center justify-between whitespace-nowrap rounded-md border border-input bg-transparent px-3 py-2 text-sm shadow-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
      className,
    )}
    ref={ref}
    {...props}
  >
    ...
    <SelectPrimitive.Icon asChild>
      <CaretSortIcon className="h-16 w-16 opacity-50" />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label className={cn('px-2 py-2 text-sm font-semibold', className)} ref={ref} {...props} />
));
